...
/*
 * This class is the main parser that we use in order
 * to obtain information from the server. It receives
 * data through POST and GET requests.
 * POST - essentially adding/updating data.
 * GET - Retrieving data.
*/
